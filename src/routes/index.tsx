...
const adminMap: Record<string, { title: string; subtitle: string; render: () => JSX.Element }> = {
...
const agentMap: Record<string, { title: string; subtitle: string; render: () => JSX.Element }> = {
